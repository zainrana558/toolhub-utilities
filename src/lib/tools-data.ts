...
export const tools: ToolDef[] = [
  ...
  },
  {
    ...
    category: "pdf",
    icon: Images,
    keywords: ["jpg to pdf", "image to pdf", "convert jpg to pdf", "png to pdf", "combine images into pdf", "photo to pdf", "images to pdf"],
    metaTitle: "Free JPG to PDF Converter \u2013 Combine Images into a PDF",
    metaDescription: "Convert JPG, PNG, WEBP, or GIF images into a single PDF document. Up to 30 images, with EXIF auto-rotation, page size, and margin controls. Free online JPG to PDF.",
  ...
  },
  {
    ...
    category: "pdf",
    icon: FilePlus2,
    keywords: ["merge pdf", "combine pdf", "join pdf", "pdf merger", "combine pdf files", "merge pdf files online", "pdf combiner"],
    metaTitle: "Free Merge PDF \u2013 Combine Multiple PDFs into One",
    metaDescription: "Combine 2 to 20 PDF files into a single document in the order you choose. No watermarks, no quality loss. Free online Merge PDF tool.",
  ...
  },
  {
    ...
    category: "pdf",
    icon: Scissors,
    keywords: ["split pdf", "pdf splitter", "divide pdf", "extract pdf pages", "pdf split", "separate pdf pages", "pdf cutter"],
    metaTitle: "Free Split PDF \u2013 Extract or Divide PDF Pages Online",
    metaDescription: "Split a PDF into individual pages, by page ranges, or extract specific pages. ZIP download for multi-file output. Free online Split PDF tool.",
  ...
  },
  {
    ...
    category: "pdf",
    icon: RotateCw,
    keywords: ["rotate pdf", "pdf rotator", "rotate pdf pages", "fix pdf orientation", "turn pdf pages", "rotate pdf 90 degrees", "pdf page rotation"],
    metaTitle: "Free Rotate PDF \u2013 Rotate PDF Pages 90, 180, or 270 Degrees",
    metaDescription: "Rotate every page of a PDF by 90\u00b0, 180\u00b0, or 270\u00b0. Fix sideways scans and orientation issues instantly. Free online Rotate PDF tool.",
  ...
  },
  {
    ...
    category: "pdf",
    icon: Stamp,
    keywords: ["watermark pdf", "pdf watermark", "add watermark to pdf", "stamp pdf", "draft watermark pdf", "confidential pdf", "pdf watermark tool"],
    metaTitle: "Free Watermark PDF \u2013 Add Text Watermark to PDF Pages",
    metaDescription: "Stamp a custom text watermark (DRAFT, CONFIDENTIAL, SAMPLE) diagonally across every page of your PDF. Choose font, opacity, color, and angle. Free online Watermark PDF.",
  ...
  },
  {
    ...
    category: "pdf",
    icon: HashIcon,
    keywords: ["pdf page numbers", "add page numbers to pdf", "number pdf pages", "pdf pagination", "pdf numbering", "page number pdf", "number pages in pdf"],
    metaTitle: "Free PDF Page Number \u2013 Add Page Numbers to PDF Online",
    metaDescription: "Add page numbers to every page of a PDF. Six positions, flexible format strings, custom font, color, and starting number. Free online PDF Page Number tool.",
  ...
  },
  {
    ...
    category: "pdf",
    icon: FileType,
    keywords: ["pdf to word", "pdf to docx", "convert pdf to word", "pdf to word document", "extract text from pdf", "pdf to word converter", "edit pdf in word"],
    metaTitle: "Free PDF to Word Converter \u2013 Convert PDF to Editable DOCX",
    metaDescription: "Convert a PDF into an editable Word (.docx) document. Text is extracted and packaged as paragraphs. Free online PDF to Word converter. No sign-up.",
  ...
  },
  {
    ...
    category: "pdf",
    icon: AlignLeft,
    keywords: ["pdf to text", "extract text from pdf", "pdf to txt", "pdf text extractor", "pdf to plain text", "convert pdf to text", "pdf text extraction"],
    metaTitle: "Free PDF to Text Extractor \u2013 Convert PDF to Plain Text",
    metaDescription: "Extract plain text from a PDF and download as a .txt file. Perfect for search indexing, copy-paste, or feeding into other tools. Free online PDF to Text.",
